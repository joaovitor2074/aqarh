...
async function scrapePesquisadores1(externalBrowser = null) {
  console.log("========================================");
  ...
  try {
    ...
    const resultados = await extractGroupPeople(page, "pesquisador", {
    ...
    console.log(`Total de pesquisadores encontrados: ${resultados.length}`);
