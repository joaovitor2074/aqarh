...
(async () => {
    ...
    const ESCAPED = `#${escapeCssId('idFormVisualizarGrupoPesquisa:j_idt288_data')}`;
    ...
    const ESCAPED_TBODY = "#idFormVisualizarGrupoPesquisa\\:j_idt288_data";
    ...
    const outFile = "resultado_final_estudantes.json";
